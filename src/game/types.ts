...
export interface StoryEvent {
  ...
  ifNot?: FlagId;
  /**
   * Происшествие: случается не сразу, а с этой вероятностью при каждой проверке — когда герой
   * приходит в место и на каждом шаге ожидания (во сне — нет). Без chance событие начинается сразу.
   */
  chance?: number;
}
