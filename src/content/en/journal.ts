...
export const JOURNAL: Record<JournalId, JournalText> = {
  ...
  lights: {
    ...
    notes: [
      ...
      'In the morning by the wicket I found tracks: from the corner tower along the wall to the wicket and back. Someone went out through the gate at night. A long stride, the left heel worn down at the side.',
